...
- **US West 2 (Oregon)**: Connects to existing VPC `vpc-0c75af08774009569` (scoutflo-vpc-ziYcAo8t-flexprice-prod)
- **AP South 1 (Mumbai)**: Connects to existing VPC `vpc-00b163f7ebb585e41` (prod-flexprice/VPC)
...
- ✅ Storage: 100 GB per broker with autoscaling
- ✅ CloudWatch alarms, SNS alerts, KMS keys, and S3 logging included

**Files:**
- `main.tf` - Cluster configuration for both regions
- `monitoring-and-alerts.tf` - CloudWatch alarms, SNS, KMS, S3 logging
- `variables.tf` - Subnet override variables
...
- ✅ Connects to existing VPCs (does not create new VPCs)
- ✅ Automatically discovers and uses private subnets
- ✅ Multi-region deployment (US and Hyderabad)
- ✅ Production-ready configuration with encryption, monitoring, and HA
- ✅ 3 brokers per cluster (one per availability zone)
- ✅ Instance type: `kafka.m7g.large`
- ✅ Storage: 100 GB per broker with autoscaling
